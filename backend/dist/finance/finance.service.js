...
let FinanceService = class FinanceService {
    planPagoRepository;
    cuotaRepository;
    constructor(planPagoRepository, cuotaRepository) {
        this.planPagoRepository = planPagoRepository;
        this.cuotaRepository = cuotaRepository;
    }
    async getPlanByFicha(fichaId) {
...
exports.FinanceService = FinanceService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(plan_pago_entity_1.PlanPago)),
